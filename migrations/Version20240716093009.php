 ...
 */
final class Version20240716093009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD waiter_id_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE orders ADD barman_id_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_E52FFDEE9DA2E63A');
        $this->addSql('DROP INDEX UNIQ_E52FFDEEF2000AA3');
        $this->addSql('ALTER TABLE orders DROP waiter_id_id');
        $this->addSql('ALTER TABLE orders DROP barman_id_id');
    }
}
