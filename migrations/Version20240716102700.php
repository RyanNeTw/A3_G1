 ...
 */
final class Version20240716102700 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "order" (id INT NOT NULL, waiter_id_id INT DEFAULT NULL, barman_id_id INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, table_number INT DEFAULT NULL, order_status VARCHAR(255) DEFAULT \'Pending\' NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE orders DROP CONSTRAINT fk_e52ffdee9da2e63a');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE drinks_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE orders_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE realtime.messages_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE orders (id INT NOT NULL, waiter_id_id INT DEFAULT NULL, barman_id_id INT DEFAULT NULL, created_at DATE NOT NULL, table_number INT NOT NULL, order_status VARCHAR(255) DEFAULT \'Pending\' NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX uniq_e52ffdeef2000aa3 ON orders (barman_id_id)');
        $this->addSql('CREATE INDEX idx_e52ffdeef2000aa3 ON orders (barman_id_id)');
        $this->addSql('CREATE INDEX idx_e52ffdee9da2e63a ON orders (waiter_id_id)');
        $this->addSql('CREATE UNIQUE INDEX uniq_e52ffdee9da2e63a ON orders (waiter_id_id)');
        ...
        $this->addSql('CREATE TABLE orders_drinks (orders_id INT NOT NULL, drinks_id INT NOT NULL, PRIMARY KEY(orders_id, drinks_id))');
        $this->addSql('CREATE INDEX idx_4b47aad8cffe9ad6 ON orders_drinks (orders_id)');
        $this->addSql('CREATE INDEX idx_4b47aad82b4b60fb ON orders_drinks (drinks_id)');
        $this->addSql('CREATE TABLE drinks (id INT NOT NULL, name VARCHAR(255) NOT NULL, price INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE realtime.subscription (id BIGINT NOT NULL, subscription_id UUID NOT NULL, entity VARCHAR(255) NOT NULL, filters VARCHAR(255) DEFAULT \'{}\' NOT NULL, claims JSONB NOT NULL, claims_role VARCHAR(255) DEFAULT \'role\' NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'utc\' NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE realtime.messages (id BIGSERIAL NOT NULL, topic TEXT NOT NULL, extension TEXT NOT NULL, inserted_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE orders ADD CONSTRAINT fk_e52ffdee9da2e63a FOREIGN KEY (waiter_id_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE orders ADD CONSTRAINT fk_e52ffdeef2000aa3 FOREIGN KEY (barman_id_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE orders_drinks ADD CONSTRAINT fk_4b47aad8cffe9ad6 FOREIGN KEY (orders_id) REFERENCES orders (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE orders_drinks ADD CONSTRAINT fk_4b47aad82b4b60fb FOREIGN KEY (drinks_id) REFERENCES drinks (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
