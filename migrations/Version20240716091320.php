 ...
 */
final class Version20240716091320 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE orders (id INT NOT NULL, created_at DATE NOT NULL, table_number INT NOT NULL, PRIMARY KEY(id))');
    }
